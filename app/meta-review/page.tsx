...
export const metadata: Metadata = {
  title: `${brandName} — Meta App Review Support`,
  description: `Meta App Review notes for the official Instagram private reply workflow in ${brandName}.`,
};
...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description={`${brandName} is designed for an Instagram professional account that wants to send private replies after keyword comments on its own posts or reels.`}
    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. {brandName} queues
